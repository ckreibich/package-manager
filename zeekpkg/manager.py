...
class Manager:
    ...
    def discover_builtin_packages(self) -> list[PackageInfo]:
        ...
        cache_file = os.path.join(CONFIG.state_dir(), "zeek_build_info_cache.json")
        build_info = None
    ...
    def has_scripts(self, installed_pkg: InstalledPackage) -> bool:
        ...
        """
        # Is this better than relying on the presence of the scripts
    ...
    def has_plugin(self, installed_pkg: InstalledPackage) -> bool:
        ...
        """
        # Is this better than relying on the presence of the build_command
        # in zkg.meta?
        return os.path.exists(
    ...
    def _interpolate_package_metadata(
        ...
        if CONFIG.zeek_dist():
            substitutions["zeek_dist"] = cast(str, CONFIG.zeek_dist())
